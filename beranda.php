...
if (isset($_POST['submit'])) {
    if (tambah($_POST) > 0) {
        echo "<script>
                alert('Da ta Berhasil Ditambahkan!');
...
<body>
    ...
    <div class="container" style="box-sizing: border-box;">
        ...
        <form action="" method="POST" style="position: relative; top: 10px; left: 22px;">
            ...
            <!-- Exel -->
            <button style="float: right; position: relative; right: 40px; cursor: pointer;" type="submit" name="cetak" target="_blank">Exel</button>

            <!-- Pdf -->
            <button style="float: right; position: relative; right: 50px; cursor: pointer;" href="pdf.php" name="pdf" target="_blank">Pdf</button>

            <!-- Print View -->
            <button onclick="window.print()" style="float: right; position: relative; right: 60px; cursor: pointer">View</button>
        </form>
